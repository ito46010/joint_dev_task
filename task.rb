...
def q8
  ...
  #  upper_case_programming_languages.map{|language|language.upcase!}
...
def q9
  ...
  # 問題の最後にendが付いているので、自分で書いたコードにはend付けなくていいと思っていましたが
  # 間違えに気付いたので下記のコードで確認しました。
...
def q10
  ...
  # 以下に回答を記載
  foods.each do|food|
    puts food.include?("うに")? "「好物です」": "「まあまあ好物です」"
  end
end
